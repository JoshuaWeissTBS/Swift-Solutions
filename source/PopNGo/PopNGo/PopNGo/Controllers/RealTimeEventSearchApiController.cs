...
namespace PopNGo.Controllers
{
    ...
    public class RealTimeEventSearchApiController : ControllerBase
    {
        ...
        private readonly ITicketLinkRepository _ticketLinkRepository;
        private readonly ILogger<RealTimeEventSearchApiController> _logger;
        public RealTimeEventSearchApiController(IRealTimeEventSearchService realTimeEventSearchService, ITicketLinkRepository ticketLinkRepository, IEventRepository eventRepository, ILogger<RealTimeEventSearchApiController> logger)
        {
        ...
        public async Task<ActionResult<IEnumerable<PopNGo.Models.DTO.Event>>> GetRealTimeAPIEvents(string q, int start)
        {
            try
            {
                ...
                //         TicketLinks = eventDetail.TicketLinks.Select(t => new PopNGo.Models.DTO.TicketLink
                //         {
                //             Source = t.Source,
                //             Link = t.Link
                //         }).ToList()
